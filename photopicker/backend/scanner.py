...
ALL_EXTENSIONS = {ext.lower() for ext in IMAGE_EXTENSIONS | RAW_EXTENSIONS}
...
def pair_jpg_raw(folder_path: str, recursive: bool = True) -> dict[str, str | None]:
